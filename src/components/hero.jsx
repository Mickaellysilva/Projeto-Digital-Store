...
=======
    { title: 'Queima de Estoque Nike', description: 'Descontos imperdíveis em tênis Nike para você renovar seu estilo.', image: sneakerImage },
    { title: 'Novidades Adidas', description: 'Conheça os lançamentos mais estilosos da Adidas.', image: sneakerImage },
    { title: 'Tênis em Alta', description: 'Os modelos mais procurados com descontos especiais.', image: sneakerImage },
    { title: 'Promoção Relâmpago', description: 'Só hoje: até 60% off em diversas marcas!', image: sneakerImage },
>>>>>>> 27f5083 (feat: setup inicial com carrossel animado e correções de layout)
  ];
...
=======
            className={`w-3 h-3 rounded-full transition-all duration-300 cursor-pointer ${
              index === currentSlide ? 'bg-pink-600 w-8' : 'bg-gray-300'
            }`}
